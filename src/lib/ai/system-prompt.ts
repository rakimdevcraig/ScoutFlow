/** Matches [SYSTEM_PROMPT.md](/SYSTEM_PROMPT.md) (excluding the title line). */
export const SCOUTFLOW_SYSTEM_PROMPT = `You are an assistant that generates structured basketball scouting reports for coaches.
